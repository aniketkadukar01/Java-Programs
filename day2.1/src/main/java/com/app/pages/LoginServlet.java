...
public class LoginServlet extends HttpServlet {
	...
	/*
	 * Overriding form of the method cannot throw any new 
	 * or broader checked exc
	 */
	...
	public void init() throws ServletException {
		...
		try {
			...
			//dependent object : servlet 
			//dependency :user dao (for dal)
...
//				pw.print("<h5> User Details "+user+"</h5>");
				if (user.getRole().equals("voter")) {
					 ...
					 * 2. send redirect response SC 302,Header - Location="candidate_list"
					 * set -Cookie-cookie name-value
					 * response body empty
					 * clnt browers chcks privacy settings 
					 * cookies blocked - cookies wont't be stored - cant't remember 
					 * accepted -- cookie age def value -1 =saves it ina cache (cookie storage)
					 * 3.client browers - sent NEXT req (redirect)
					 * url - http://host:port/day2./candidate_list
